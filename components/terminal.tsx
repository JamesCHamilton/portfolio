...
export function Terminal() {
  ...
  const commands = {
    ...
    skills: () => [
      ...
      "💻 Languages:  Python, Java, JavaScript, HTML, CSS, SQL, TypeScript, C#, Go, Lua",
      "⚡ Frameworks: React.js, Next.js, Express.js, Node.js, FastAPI, Spring Boot, Deno, .NET",
      "☁️ DevOps:     Docker, AWS EC2/S3/Route 53, NGINX, Azure, CI/CD, Vercel",
      "🗄️ Databases:  MongoDB, PostgreSQL, Firebase, Redis, Supabase",
    ],
    experience: () => [
      "💼 WORK EXPERIENCE",
      "1. Software Engineer (Parkidsy) | Seidenberg Creative Lab (Mar 2026 - Present)",
      "   • Architected mobile-optimized Next.js/Bun web app inside native iOS/Android WebViews.",
      "   • Engineered relational Supabase schema for secure auth and real-time storage.",
      "2. NSF CISE REU Software Engineer | Pace University & NY State Hospitals (May 2026 - Present)",
      "   • Engineered native Android tablet app; built local LLM/RAG HIPAA-compliant chatbot.",
      "3. Software Engineer (Founding Engineer) | Arcampass (Feb 2025 - Jan 2026)",
      "   • Shipped learning platform via Next.js/Express/MongoDB; database latency 320ms -> 140ms.",
      "   • Containerized with Docker/NGINX; built 14k course records data ingestion pipeline.",
      "4. AI Research Assistant (CRA Funded) | Pace University (Apr 2025 - Sep 2025)",
      "   • Developed Python benchmarking framework evaluating 5 LLMs on 50 software engineering tasks.",
      "5. Software Engineer Intern | BZ Marketing (May 2024 - Sep 2024)",
      "   • Redesigned landing page (SEO 71 -> 88); built Django/OpenAI keyword tool; Redis caching.",
      "6. Coding Instructor | TheCoderSchool (May 2023 - Present)",
      "   • Taught 100+ hours in Python, JS, Scratch, Lua, C#, HTML/CSS to students aged 7-18.",
      "   • Mentored 20+ students from ideation to deployment of full-stack projects.",
    ],
    projects: () => [
      "🚀 FEATURED PROJECTS",
      ...
      "2. EthicsOS (Python | FastAPI | PostgreSQL | OpenAI API | Supabase)",
      "   • Top 10 Finalist, Cornell Hackathon clinical orchestration platform.",
      "   • Enforced JSON schemas for adjudication; optimized PG JSONB/GIN-indexing for FHIR queries.",
      "3. Parkidsy (Next.js | Bun | Supabase | TypeScript)",
      "   • Deployed at: https://parkidsy.voicesights.xyz",
      "   • Full-stack mobile-optimized web app wrapped inside native iOS/Android WebViews.",
      "4. Commuter App Challenge (MTA & NJ Transit Leaders Finalist - Nov 2024)",
